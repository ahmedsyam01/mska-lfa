...
const Header: React.FC = () => {
  ...
  const navigationItems = [
    ...
    { name: 'أخبار محلية', href: '/local-news' },
    { name: 'أخبار سياسية', href: '/politics' },
    { name: 'أخبار اقتصادية', href: '/economics' },
    { name: 'أخبار رياضية', href: '/sports' },
    { name: 'أخبار تعليمية', href: '/education' },
    { name: 'أخبار صحية', href: '/health' },
    { name: 'أخبار تقنية', href: '/technology' },
    { name: 'أخبار ثقافية', href: '/culture' },
    { name: 'أخبار بيئية', href: '/environment' },
    { name: 'أخبار دولية', href: '/international' },
