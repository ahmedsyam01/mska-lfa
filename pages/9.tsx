      ...
      <div className="min-h-screen bg-gray-50 py-8" dir="rtl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">الصفحة 9</h1>
            <p className="text-xl text-gray-600">أخبار موريتانيا - الصفحة التاسعة</p>
          </div>

          {/* Pagination Info */}
          <div className="text-center mb-8">
            <div className="bg-rose-100 text-rose-800 px-4 py-2 rounded-full inline-flex items-center gap-2">
                ...
                <div key={article.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="bg-rose-600 text-white px-4 py-2 rounded-md hover:bg-rose-700 transition-colors duration-200">
                        اقرأ المزيد
                      </button>
                    </div>
                  </div>
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="px-3 py-2 bg-rose-600 text-white rounded-md font-medium">
                {pagination.page}
              </span>
            ...
            <a
              href="/10"
              className="flex items-center gap-2 px-4 py-2 bg-rose-600 text-white rounded-md hover:bg-rose-700 transition-colors duration-200"
            >
              الصفحة التالية
