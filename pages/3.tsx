  ...
  useEffect(() => {
    const fetchPage3News = async () => {
      try {
        ...
        console.error('Error fetching articles for page 3:', err);
      ...
      <div className="min-h-screen py-12" dir="rtl">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-bold text-gradient mb-6">الصفحة 3</h1>
          ...
          <div className="flex justify-center items-center gap-6">
            <a href="/2" className="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-mauritania-green to-mauritania-green-dark text-white rounded-2xl hover:from-mauritania-green-dark hover:to-mauritania-green transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
            ...
            <a href="/4" className="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-mauritania-gold to-mauritania-red text-white rounded-2xl hover:from-mauritania-red hover:to-mauritania-gold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
