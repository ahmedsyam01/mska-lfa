      ...
      <div className="min-h-screen bg-gray-50 py-8" dir="rtl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">أخبار موريتانيا - الصفحة الرابعة</p>
          </div>

          {/* Pagination Info */}
          <div className="text-center mb-8">
            <div className="bg-purple-100 text-purple-800 px-4 py-2 rounded-full inline-flex items-center gap-2">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="px-3 py-2 bg-purple-600 text-white rounded-md font-medium">
                {pagination.page}
              </span>
